// JIS配列として認識されたキーボードをUS配列として使う & MacとWindowsのコンパチ & Tap Dance
...
[_JIS] = {
  ...
  {CTL_ZH,  ADJUST,  KC_LALT, MY_GUI,  TAP_L,   KC_SPC,  KC_SPC,  M_KHKR,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
[_US] = {
  ...
  {CTL_ZH,  ADJUST,  KC_LALT, KC_LGUI, TAP_L,   KC_SPC,  KC_SPC,  M_KHRU,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT}
},
...
/* Function_1  移動、ウインドウやタブの切り替え、レイヤーのトグル、マウス操作（マウスキーはデフォルトでは無効）
 * ,-----------------------------------------------------------------------------------.
